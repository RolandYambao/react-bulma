                            ...
                            <div className="column is-narrow">
                                <article className="message is-primary">
                                    ...
                                    <div className="message-body">
                                        ...
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Force of Eagle's Claw</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Red Sun, Silver Moon</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Palm of the Iron Fox</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Monkey Leaps Through Mist</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Leopard Stalks in Snow</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Black Heart, White Mountain</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Sting of the Scorpion's Tail</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Nightingale Sings No More</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Wolf's Breath, Dragon Fire</span></div>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div className="column is-narrow">
                                <article className="message is-link">
                                    ...
                                    <div className="message-body">
                                        ...
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Moon Rises, Raven Seeks</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Leopard Snares Rabbit</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Blind Cannibal Assassins</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Carry Tiger to Mountain</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Black Wind Howls</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Dragonfly's Last Dance</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Leopard Catches Cloud</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Chamber of the Scorpion</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Raven's Feather, Phoenix Blood</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>The Boar And The Butterfly</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Cobra Fang, Panther Claw</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Black Lothus, White Rose</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Curse of the Red Rain</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Requiem for the Fallen</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Seven Strike as One</span></div>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div className="column is-narrow">
                                <article className="message is-info">
                                    ...
                                    <div className="message-body">
                                        ...
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Aorta</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Alveolae</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>TALISMAN</span></div>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div className="column is-narrow">
                                <article className="message is-success">
                                    ...
                                    <div className="message-body">
                                        ...
                                        <div className="board-item">
                                            <div className="board-item-content"><span>weasel</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>solana</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>hydro</span></div>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div className="column is-narrow">
                                <article className="message is-warning">
                                    ...
                                    <div className="message-body">
                                        ...
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Europa</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Tycho</span></div>
                                        </div>
                                        <div className="board-item">
                                            <div className="board-item-content"><span>Io</span></div>
                                        </div>
                                    </div>
                                </article>
                            </div>
